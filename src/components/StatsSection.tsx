      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-balance">
            ...
            <span className="gradient-primary bg-clip-text text-transparent"> Professionals</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stats.map((stat, index) => (
            <div 
              key={index} 
              className="bg-card border border-border rounded-xl p-8 text-center shadow-card hover:shadow-elegant transition-smooth group"
            >
